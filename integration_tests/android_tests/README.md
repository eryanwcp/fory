...
retention rules, generated operations for the exact target-Mixin pair, and equivalent application-authored
exact rules for unannotated ordinary classes. Mixin coverage
